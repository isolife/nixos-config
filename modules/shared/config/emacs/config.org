...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "iso"
    user-mail-address "vetle.olstad@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/iso/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/iso/bin" "/profile/bin" "/Users/iso/.npm-packages/bin" "/Users/iso/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
